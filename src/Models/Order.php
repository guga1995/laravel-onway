...
class Order
{
	...
	public function toArray(): array
	{
		$result = [
			...
			'from_city' => $this->_fromCity,
			'from_name' => $this->_fromName,
			'from_phone' => $this->_fromPhone,
			'from_address' => $this->_fromAddress,
			'from_company' => $this->_fromCompany,
			'to_city' => $this->_toCity,
			'to_name' => $this->_toName,
			'to_phone' => $this->_toPhone,
			'to_address' => $this->_toAddress,
			'to_company' => $this->_toCompany,
			'services' => $this->_services,
			'parcel' => $this->_parcel,
			'payment' => $this->_payment,
			'payer' => $this->_payer,
			'order_price' => $this->_orderPrice,
			'weight' => $this->_weight,
			'quantity' => $this->_quantity,
			'service_level' => $this->_serviceLevel,
			'order_number' => $this->_orderNumber,
			'order_detail' => $this->_orderDetail,
			'invoice_amount' => $this->_invoiceAmount,
			'brittle' => $this->_brittle,
			'receiver_shipprice_pay' => $this->_receiverShippricePay,
