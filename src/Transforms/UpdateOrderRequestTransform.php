...
class UpdateOrderRequestTransform extends BaseTransform
{
	public function transform(): array
	{
		...
		return [
			...
			"off_date" => strtotime($order_info["of_date"]) ? Carbon::parse($order_info["of_date"])->toDateString() : null,
			...
			"shipping_price" => (float)$order_info["shipprice"],
			"additional_services_price" => (float)$order_info["additional_services"],
